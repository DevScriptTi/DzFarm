...
export function LandingPicture() {
    return (
        <div
            className="hidden relative lg:flex items-center justify-center w-1/2"
        >
            <div className="absolute inset-0 bg-primary dark:bg-dark-primary blur-3xl -z-10 rounded-full opacity-50"></div>
            <Image alt="landingPicture" src={'/landing1.png'} width={800} height={800} />
        </div>
    )
}